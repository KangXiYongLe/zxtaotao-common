...
/**
 * BeanFactoryAware 通过Bean工厂获取bean，保证HttpClient对象是多例
 * @author zengkang
 *
 */
@Service
public class ApiService implements BeanFactoryAware {
    ...
    private RequestConfig requestConfig;//封装请求参数对象

    private BeanFactory beanFactory;//通过Bean工厂获取bean，保证HttpClient对象是多例
    ...
    public String doGet(String url) throws ClientProtocolException, IOException {
     // 创建http GET请求
        ...
        try {
         ...
         // 判断返回状态是否为200，如果是200，以utf-8编码，将响应返回给调用方
     ...
     // 创建http POST请求
        ...
        try {
         // 执行请求
            ...
            if (entity == null) {
                return new HttpResult(Integer.valueOf(response.getStatusLine().getStatusCode()), null);
            }
            return new HttpResult(Integer.valueOf(response.getStatusLine().getStatusCode()),
